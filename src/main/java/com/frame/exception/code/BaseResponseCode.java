package com.frame.exception.code;
...
public enum BaseResponseCode implements ResponseCodeInterface{
    ...
    CODE_ERROR(4030002, "验证码错误"),
    PHONE_NUMBER_ERROR(4030003, "手机号码格式错误"),
    CODE_SEND_ERROR(4030004, "验证码发送频繁，请一分钟后再试"),
    PHONE_HAS_REGISTER(4030005, "手机号码已经被注册"),
    ERROR_TOKEN_VALIDATE(4030006, "权限异常，请重新登录"),
    OUT_OF_EXP_TOKEN(4030007, "登录过期，请重新登录"),
    NOT_LOGIN(4030008, "请先登录"),
    NOT_EQUAL_PASSWORD(4030009, "确认密码与新密码不一致"),
    PASSWORD_ERROR(4030010, "密码错误"),
    ;
